...
# Generated by qmake (2.01a) (Qt 4.6.3) on: ?? 9? 25 11:35:00 2010
...
SOURCES       = main.cpp \
		...
		hand_wdialog.cpp \
		communicat.cpp \
		addic_thread.cpp moc_dictionary.cpp \
		moc_hand_wdialog.cpp \
		moc_communicat.cpp \
		moc_addic_thread.cpp
OBJECTS       = main.o \
		dictionary.o \
		hand_wdialog.o \
		communicat.o \
...
compiler_moc_header_make_all: moc_dictionary.cpp moc_hand_wdialog.cpp moc_communicat.cpp moc_addic_thread.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_dictionary.cpp moc_hand_wdialog.cpp moc_communicat.cpp moc_addic_thread.cpp
...
moc_addic_thread.cpp: addic_thread.h
	/home/huguohu/qtsdk-2010.04/qt/bin/moc $(DEFINES) $(INCPATH) addic_thread.h -o moc_addic_thread.cpp
...
addic_thread.o: addic_thread.cpp addic_thread.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o addic_thread.o addic_thread.cpp
...
moc_addic_thread.o: moc_addic_thread.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_addic_thread.o moc_addic_thread.cpp
